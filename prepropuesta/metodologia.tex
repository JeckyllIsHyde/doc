...
\tagged{handout-tufte}{%
  ...
  \begin{figure}[!htb]
    \centering
    \includegraphics[width=7.0cm]{../images/MakeTheFramework_7.png}
    \caption{Hacia un Framework de Rob\'otica B\'ipeda}
    \label{fig:method}
  \end{figure}
}%
\mode<presentation>{
  ...
  \end{frame}
  \mode<all>
  \input{sld-make-framework}
  \mode<all>
  \input{sld-algoritmo-metodologia}
  \mode*
}\tagged{handout-tufte}{\small\vspace{-0.7cm}}
...
, se repetir\'a a lo largo del desarrollo de la tesis, el cual se iterar\'a durante al menos cinco veces, (ver Fig.\ref{fig:method}, en donde se enumeran cada uno de los pasos).\tagged{handout-tufte}{\normalsize\vspace{-0.3cm}}
\iftagged{handout-tufte}{
  \begin{figure}[!htb]
    \centering
