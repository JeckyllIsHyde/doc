...
\mode<presentation>{
  ...
  \begin{frame}[plain,t,label=exp_biomecanica]
    ...
    \hspace*{-0.8cm}\parbox[t]{\textwidth}{
      ...
      \only<1>{\includegraphics[height=7.0cm]{../images/ShortBiomechanics_0.png}}%
      \only<2>{\includegraphics[height=7.0cm]{../images/ShortBiomechanics_1.png}}%
      \only<3>{\includegraphics[height=7.0cm]{../images/ShortBiomechanics_2.png}}%
      \only<4>{\includegraphics[height=7.0cm]{../images/ShortBiomechanics_3.png}}%
      \only<5>{\includegraphics[height=7.0cm]{../images/ShortBiomechanics_4.png}}%
    }
