...
\mode<presentation>{
  ...
  % \begin{frame}
  %   \transduration{5}
  %   \includegraphics[height=7.0cm]{../images/TimeLine01.png}
  % \end{frame}
  ...
  %   \frametitle{Breve historia de la rob\'otica b\'ipeda}
  %   \framesubtitle{Para entrar en contexto}
  %   \includegraphics[height=0.6cm]{../images/WL-1-1967.png}
  %   \includegraphics[height=0.6cm]{../images/WL-3-1969.png}
  %   \includegraphics[height=0.6cm]{../images/IshiroKato.png}
  %   \includegraphics[height=0.6cm]{../images/WL-5-1971.png}
  %   \includegraphics[height=0.6cm]{../images/WABOT-1.png}
  %   \includegraphics[height=0.6cm]{../images/WL-9DR-1980.png}
  %   \includegraphics[height=0.6cm]{../images/WL-10RD-1984.png}
  %   \includegraphics[height=0.6cm]{../images/WL-16RV-2007.png}
  %   \includegraphics[height=0.6cm]{../images/WL-16-newPurposes.png}
  %   \includegraphics[height=0.6cm]{../images/WABIAN-2R-2008.png}\\
  %   \includegraphics[height=0.6cm]{../images/MiomirVukobratovic.png}
  %   \includegraphics[height=0.6cm]{../images/ZMP-concept.png}%1973
  %   \includegraphics[height=0.6cm]{../images/Kato-Vukobratovic.png}\\
  %   \includegraphics[height=0.6cm]{../images/Honda-E0.png}%1986
  %   \includegraphics[height=0.6cm]{../images/Honda-E1-E2-E3.png}%1987-1991
  %   \includegraphics[height=0.6cm]{../images/Honda-E4-E5-E6.png}%1991-1993
  %   \includegraphics[height=0.6cm]{../images/Honda-P1-P2-P3.png}%1993-1997
  %   \includegraphics[height=0.6cm]{../images/Honda-ASIMO.png}\\%2000-
  %   \includegraphics[height=0.6cm]{../images/MIT-3D-oneLegHopper-1983.png}%1983-1984
  %   \includegraphics[height=0.6cm]{../images/MIT-3D-hopper-biped-1989.png}%1989-1995
  %   \includegraphics[height=0.6cm]{../images/MIT-Geekbot-1994.png}%1994-1995
  %   \includegraphics[height=0.6cm]{../images/MIT-SpringFlamingo-1996.png}%1996-2000
  %   \includegraphics[height=0.6cm]{../images/MIT-M2-1998.png}%1998-
  %   \includegraphics[height=0.6cm]{../images/RussTedrake.png}
  %   \includegraphics[height=0.6cm]{../images/MIT-Toddler.png}\\%2005-
  %   \includegraphics[height=0.6cm]{../images/PDW-conceptTadMcGeer1988.png}%1988-1990
  %   \includegraphics[height=0.6cm]{../images/AndyRuina.png}
  %   \includegraphics[height=0.6cm]{../images/KuoStabilization-1999.png}%1999
  %   \includegraphics[height=0.6cm]{../images/CornellPWDRuina.png}
  %   \includegraphics[height=0.6cm]{../images/PWD-GarciaPhDCornell.png}%1999
  %   \includegraphics[height=0.6cm]{../images/StevenCollins.png}%
  %   \includegraphics[height=0.6cm]{../images/CornellPWDSCollins.png}%2001
  %   \includegraphics[height=0.6cm]{../images/CMU-SCollinsPWD.png}\\%
  %   \includegraphics[height=0.6cm]{../images/MartijnWisse.png}%
  %   \includegraphics[height=0.6cm]{../images/DelftWalker.png}%\\%1998-2004
  %   \includegraphics[height=0.6cm]{../images/RabbitCNRS-1997}%\\%1997-2003-
  %   \includegraphics[height=0.6cm]{../images/WesterveltHZD.png}%2003
  %   \includegraphics[height=0.6cm]{../images/ERNIE-2007.png}%2007
  %   \includegraphics[height=0.6cm]{../images/AtriasBipedUMitchigan.png}%2012-CMU
  %   \includegraphics[height=0.6cm]{../images/TULIP-2006.png}%2006-
  %   \includegraphics[height=0.6cm]{../images/NAO-AldebaranRobotics-2004.png}%2004-2007-
  % \end{frame}
  \begin{frame}
    \transduration<1->{3}
    ...
    \begin{columns}[T]
      \begin{column}{2.0cm}
        \includegraphics[height=7.5cm]{../images/TimeLineTendencias01.png}
      \end{column}
      \begin{column}{5.0cm}
        \only<1>{\scriptsize
          \begin{center}
            \textbf{Universidad de Waseda}\\
            \begin{center}
              \includegraphics[height=1.0cm]{../images/WasedaLogo.png}
            \end{center}
            \begin{itemize}
            ...
            \item Aplicaciones:
              ...
              \item Caminata asistida
              \item Transporte de personas
              \item Transporte de material
              \end{itemize}
            \end{itemize}
            \textbf{Investigaci\'on:}\\
            Balance, control de cuerpo completo y optimizaci\'on de energ\'ia
          \end{center}
        }
        \only<2>{\scriptsize
          \begin{center}
            ...
            \begin{center}
              \includegraphics[height=0.6cm]{../images/HondaLogo.png}\\
              \includegraphics[height=0.6cm]{../images/IHMCLogo.png}
            \end{center}
            \begin{itemize}
            \item Capture Points
            \item Balance
        ...
        \only<3>{\scriptsize
          \begin{center}
            ...
            \end{itemize}
            \textbf{Investigaci\'on:}\\
            Control y generaci\'on de caminata, capa cognitiva
          \end{center}
        }
        \only<4>{\scriptsize
          \begin{center}
        ...
        \only<5>{\scriptsize
          \begin{center}
            ...
            \begin{itemize}
            \item Construciones de bajo costo
            \item Aprendizaje de m\'aquina
            \item Vibraci\'on y eficiencia energ\'etica
            \item Actuadores
            \item BAN
            \item Terrenos Irregulares
            \item Tendencias Bio-inspiradas
            \end{itemize}
            \textbf{Investigaci\'on:}\\
            Capa de sensores, BAN ,Capa cognitiva, eficiencia energ\'etica.
          \end{center}
        }
        \only<6>{\scriptsize
          \begin{center}
            \textbf{CMU y Cornell University}\\
        ...
        \only<7>{\scriptsize
          \begin{center}
            \textbf{Delft University}\\
            \includegraphics[height=1.0cm]{../images/DelftLogo.png}\\
            \begin{itemize}
            \item Aprendizaje de m\'aquina
            \item Running robot
            \item Eficiencia energ\'etica, caderas, tobillos y brazos
            \item Air Muscles and DC motors
            \item Modelos masa-resorte
            \item Futbol de robots
            \end{itemize}
            \textbf{Investigaci\'on:}\\
            Capa de f\'isica, Capa de control, Capa cognitiva y eficiencia energ\'etica.
          \end{center}
        }
        \only<8>{\scriptsize
          \begin{center}
            \textbf{RunBot}\\
            \includegraphics[height=2.0cm]{../images/RunBotLogo.png}\\
            \begin{itemize}
            \item Aprendizaje de m\'aquina
            \item Redes neuronales
        ...
        \only<9>{\scriptsize
          \begin{center}
            ...
            \begin{itemize}
            \item Control
            \item Planeaci\'on de trayectoria
            \item Running Mode
            \end{itemize}
            \textbf{Investigaci\'on:}\\
            Capa de control y eficiencia energ\'etica.
          \end{center}
        }
        \only<10>{\scriptsize
          \begin{center}
      ...
      \begin{column}{3.5cm}
        \only<1>{
          \begin{center}
            \textbf{Familia WL-16}\\
            \includegraphics[height=2.0cm]{../images/WasedaTendencias.png}            
          \end{center}
        }
        \only<2>{
          \begin{center}
            \textbf{Rob\'otica b\'ipeda}\\
        ...
        \only<3>{
          \begin{center}
            \textbf{NAO}\\
            \includegraphics[height=4.0cm]{../images/NaoTendencias.png}
          \end{center}
        }
        \only<4>{
          \begin{center}
            \textbf{Robot Locomotion Group}\\
            \includegraphics[height=4.0cm]{../images/MITTendencias.png}
          \end{center}
        }
        \only<5>{
          \begin{center}
            \textbf{BIRLab}\\
            \includegraphics[height=2.5cm]{../images/ETHTendencias.png}
          \end{center}
        }
        \only<6>{
          \begin{center}
            \textbf{Biorobotics and locomotion Lab}\\
            \includegraphics[height=4.0cm]{../images/CMUCornellTendencias.png}
          \end{center}
        }
        \only<7>{
          \begin{center}
            \textbf{DBL - Delft Biorobotics Lab}\\
        ...
        \only<8>{
          \begin{center}
            ...
            \includegraphics[height=4.5cm]{../images/RunBotTendencias.png}
          \end{center}
        }
        \only<9>{
          \begin{center}
            \textbf{Nuevos estudios}\\
            \includegraphics[height=4.5cm]{../images/CNRSTendencias.png}
          \end{center}
        }
        \only<10>{
          \begin{center}
            \textbf{DLR-biped}\\
            \includegraphics[height=4.5cm]{../images/DLRTendencias.png}
          \end{center}
        }
