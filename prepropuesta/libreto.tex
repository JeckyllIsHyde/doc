...
\rightline{\includeslide[width=3.0cm]{plataformas}}\\
  2. --- los cuales han construido una gran diversidad de plataformas con el fin de investigar sobre del tema. Es notorio que las tendencias a bajar los costos de los prototipos son cada vez mayores.\anext\marginpar{\includeslide[width=3.0cm]{def_multi<1>}}\\
...
\rightline{\includeslide[width=3.0cm]{def_multi<2>}}\\
...
\anext\\\rightline{\includeslide[width=3.0cm]{def_multi<7>}}\\
