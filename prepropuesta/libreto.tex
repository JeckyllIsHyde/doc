...
\mode<article>{
  ...
  --- Buenas tardes, mi nombre es Jaime Andr\'es Castillo Le\'on.\marginpar{\includeslide[width=3.0cm]{presentacion}}\todo{Acuerdese de hablar duro}\\
  ...
  --- En los siguientes minutos voy hablar de los temas descritos en la barra izquierda de la presentaci\'on.\anext\marginpar{\includeslide[width=3.0cm]{justificacion}}\\
  %% JUSTIFICACION

  \section{Justificaci\'on}
  \label{sec:justificacion}

  --- Comenzar\'e por la justificaci\'on del proyecto, respondiendo al \emph{Por qu\'e de esta investigaci\'on}.\anext\marginpar{\includeslide[width=3.0cm]{laboratorios}}\\
  1. --- Existe un gran inter\'es en diversos laboratorios en el mundo por este tema,\anext\\
\rightline{\includeslide[width=3.0cm]{plataformas}}\\
  2. --- los cuales han construido una gran diversidad de plataformas con el fin de investigar sobre del tema. Es notorio que las tendencias a bajar los costos de los prototipos son cada vez mayores.\anext\marginpar{\includeslide[width=3.0cm]{multidisciplinas<1>}}\\
...
\rightline{\includeslide[width=3.0cm]{multidisciplinas<2>}}\\
  ...
  --- y el Control.\ngoto\bato\marginpar{\includeslide[width=3.0cm]{exp_control<1>}}\\
\anext\\\rightline{\includeslide[width=3.0cm]{multidisciplinas<7>}}\\
  4. --- Mencionar\'e algunos aspectos que me motivan a la realizaci\'on de esta investigaci\'on:\anext\marginpar{\includeslide[width=3.0cm]{motivacion<1>}...}\\
  --- Primero: Un ejemplo de dise\~no desarrollado anteriormente por m\'i, en donde se foment\'o: el bajo costo\anext, los ejemplos did\'acticos\anext, la modularidad de las estructuras\anext, el prototipado r\'apido\nnext\marginpar{\includeslide[width=3.0cm]{motivacion<6>}} y se integr\'o a una metodolog\'ia de dise\~no. todo esto como herramienta de estudio para la rob\'otica.\anext\\
\rightline{\includeslide[width=3.0cm]{motivacion<7>}}\\
  Segundo: --- El tema de la rob\'otica b\'ipeda integra temas que me trasnochan de forma natural, me apasionan y me motivan.\anext\marginpar{\includeslide[width=3.0cm]{motivacion<8>}...}\\
  Tercero: --- Enumerar\'e algunos resultados, soluciones o productos que motivan mi investigaci\'on a futuro: la Teleoperaci\'on\anext, el transporte\anext, el dise\~no pr\'otesis y asistencia m\'ovil\anext\marginpar{\includeslide[width=3.0cm]{motivacion<11>}...}, la educaci\'on\anext y el entretenimiento y la inteligencia artificial.\anext\\
\rightline{\includeslide[width=3.0cm]{motivacion<14>}}\\
